...
def login():
    ...
    return render_template("login.html", user=current_user, csrf_token=generate_csrf())
    ...
    if request.method == 'POST':
        try:
            ...
            if user:
                ...
                return render_template("sign_up.html", user=current_user, csrf_token=generate_csrf())
